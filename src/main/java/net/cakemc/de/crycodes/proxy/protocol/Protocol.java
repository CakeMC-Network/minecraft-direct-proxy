...
// 0
    GAME {
        {
            TO_CLIENT.registerPacket(KeepAliveRequestPacket.class, KeepAliveRequestPacket::new, map(ProtocolVersion.MINECRAFT_1_8, 0), map(ProtocolVersion.MINECRAFT_1_9, 31), map(ProtocolVersion.MINECRAFT_1_13, 33), map(ProtocolVersion.MINECRAFT_1_14, 32), map(ProtocolVersion.MINECRAFT_1_15, 33), map(ProtocolVersion.MINECRAFT_1_16, 32), map(ProtocolVersion.MINECRAFT_1_16_2, 31), map(ProtocolVersion.MINECRAFT_1_17, 33), map(ProtocolVersion.MINECRAFT_1_19, 30), map(ProtocolVersion.MINECRAFT_1_19_1, 32), map(ProtocolVersion.MINECRAFT_1_19_3, 31), map(ProtocolVersion.MINECRAFT_1_19_4, 35), map(ProtocolVersion.MINECRAFT_1_20_2, 36), map(ProtocolVersion.MINECRAFT_1_20_5, 38));
            ...
            TO_SERVER.registerPacket(KeepAliveRequestPacket.class, KeepAliveRequestPacket::new, map(ProtocolVersion.MINECRAFT_1_8, 0), map(ProtocolVersion.MINECRAFT_1_9, 11), map(ProtocolVersion.MINECRAFT_1_12, 12), map(ProtocolVersion.MINECRAFT_1_12_1, 11), map(ProtocolVersion.MINECRAFT_1_13, 14), map(ProtocolVersion.MINECRAFT_1_14, 15), map(ProtocolVersion.MINECRAFT_1_16, 16), map(ProtocolVersion.MINECRAFT_1_17, 15), map(ProtocolVersion.MINECRAFT_1_19, 17), map(ProtocolVersion.MINECRAFT_1_19_1, 18), map(ProtocolVersion.MINECRAFT_1_19_3, 17), map(ProtocolVersion.MINECRAFT_1_19_4, 18), map(ProtocolVersion.MINECRAFT_1_20_2, 20), map(ProtocolVersion.MINECRAFT_1_20_3, 21), map(ProtocolVersion.MINECRAFT_1_20_5, 24), map(ProtocolVersion.MINECRAFT_1_21_2, 26));
    ...
    CONFIGURATION {
        {
            ...
            TO_CLIENT.registerPacket(KeepAliveRequestPacket.class, KeepAliveRequestPacket::new, map(ProtocolVersion.MINECRAFT_1_20_2, 3), map(ProtocolVersion.MINECRAFT_1_20_5, 4));
            ...
            TO_SERVER.registerPacket(KeepAliveRequestPacket.class, KeepAliveRequestPacket::new, map(ProtocolVersion.MINECRAFT_1_20_2, 3), map(ProtocolVersion.MINECRAFT_1_20_5, 4));
        }
    };
